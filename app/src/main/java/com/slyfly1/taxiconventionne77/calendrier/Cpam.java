...
public class Cpam extends AppCompatActivity implements DatePickerDialog.OnDateSetListener {
  ...
  /*  public void nbrcb() {
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        switch(item.getItemId()) {
            case R.id.calendar:
                Intent mainIntent = new Intent(Cpam.this, MainActivitycalendrier.class);
                startActivity(mainIntent);
                return true;
            case R.id.weekly:
                if (TYPE.equals("Monthly")) {
                    Intent weeklyIntent = new Intent(Cpam.this, Cpam.class);
            ...
            case R.id.monthly:
                if (TYPE.equals(("Weekly"))) {
                    Intent monthlyIntent = new Intent(Cpam.this, Cpam.class);
                    monthlyIntent.putExtra("Type", "Monthly");
                    startActivity(monthlyIntent);
                }
                return true;
            case R.id.settings:
                Intent settingsIntent = new Intent(Cpam.this, SettingsActivity.class);
                startActivity(settingsIntent);
                return true;
            case R.id.graph:
                Intent graphIntent= new Intent (Cpam.this,Graphique.class);
                startActivity(graphIntent);
                return true;
            case R.id.avalider:
                Intent cam1Intent= new Intent (Cpam.this, Cpam.class);
                startActivity(cam1Intent);
                return true;
            case R.id.validerfinal:
                Intent validerIntent= new Intent (Cpam.this, Cpamvalider.class);
